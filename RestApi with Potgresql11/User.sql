...
COPY kiwong.orang (password, tgl_masuk, tanggal_keluar, alamat, telepon, username, namalengkap, id) FROM stdin;
abc	2019-04-16	2019-04-23	a	1	a	a	1
aaadasd	2019-04-17	2019-04-16	b	2	b	b	2
\.
